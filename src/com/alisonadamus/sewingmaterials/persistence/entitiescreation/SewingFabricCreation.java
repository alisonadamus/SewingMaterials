...
/**
 * Клас для створення об'єктів тканини {@link SewingFabric}. Реалізує інтерфейс
 * {@link CreateEntities}.
 */
public class SewingFabricCreation implements CreateEntities<SewingFabric> {
    /**
     * Створює об'єкти тканини з заданими даними.
     *
     * @return Список створених об'єктів тканини.
     */
    @Override
    public List<SewingFabric> createdObjects() {
        return new ArrayList<>(List.of(new SewingFabric("Бавовна", "Червоний", 240, 73.25),
